...
<span>Нет в наличии</span>
    ...
    case "Доставка":
      tabContent = <div className={styles.delivery} >
        <p>
          Доставка по Нижнему Новгороду и Нижегородской обл.<br />
          <ul>
          ...
          Условия доставки по Нижегородской области оговариваются отдельно. <br />
        </p>

<p>
  Доставка в другие регионы России <br />
  Стоимость доставки до терминала транспортной компании на заказы до 5000 рублей – 100 рублей. Свыше 5000 рублей доставка до терминала транспортной компании бесплатная. <br />
  <ul>
    <li>Энергия</li>
    <li>Деловые линии</li>
    <li>ПЭК</li>
  ...
  Транспортная организация доставит груз в любом направлении по всей территории России. Стоимость доставки определяется тарифами транспортных <br />
   компаний и зависит от удаленности Вашего населенного пункта от Москвы, способа доставки, срочности доставки, веса и габаритов товара.
  Данная услуга <br />
   позволяет максимально экономить Ваше время и силы.
</p>
      </div>
      break;
    case "Оплата":
...
Банковские реквизиты для перечисления д/с: <br />
 ООО  Хим-НН ИНН <br />
  5257135802 / КПП 525701001р/с 40702810290080000187 Филиал Приволжский  ПАО Банк  ФК Открытие  г. Нижний Новгород к/с 30101810300000000881 БИК 042282881р/с <br />
  40702810829050009036 Филиал «Нижегородский» АО «АЛЬФА-БАНК» г. Нижний Новгород к/с 30101810200000000824 БИК 042202824
      </div>
      break;
